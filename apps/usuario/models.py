...
class Usuario(AbstractBaseUser, PermissionsMixin):
    username = models.IntegerField('Legajo', unique=True, validators=[MaxValueValidator(99999), MinValueValidator(1)])
    email = models.EmailField('Email de usuario', max_length=254)
    name = models.CharField('Nombre', blank=True, max_length=50, null=True)
    last_name = models.CharField('Apellido', blank=True, max_length=50, null=True)
