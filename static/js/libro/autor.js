    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for(let i = 0;i < response.length;i++){
                ...
                fila += ' onclick = "abrir_modal(edicion,\'/libro/editar_autor/' + response[i]['pk']+'/\');"> EDITAR </button>';
                fila += '<button type = "button" class = "btn btn-danger tableButton  btn-sm"';
                fila += 'onclick = "abrir_modal(eliminacion,\'/libro/eliminar_autor/' + response[i]['pk'] +'/\');"> ELIMINAR </buttton></td>';
                fila += '</tr>';
